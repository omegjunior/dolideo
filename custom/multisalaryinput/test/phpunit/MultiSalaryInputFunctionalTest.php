...
/**
 * \file    test/phpunit/MultiSalaryInputFunctionalTest.php
...
/**
 * Class MultiSalaryInputFunctionalTest
 *
 ...
 *
 * @package Testmultisalaryinput
 */
class MultiSalaryInputFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modMultiSalaryInput')->click();
		} else {
			// Disable the module
			$this->byHref('modMultiSalaryInput')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/multisalaryinput/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('multisalaryinput/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/multisalaryinput/admin/about.php');
		$this->authenticate();
		return $this->assertContains('multisalaryinput/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('multisalaryinputwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modMultiSalaryInput_MultiSalaryInputTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modMultiSalaryInput_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
