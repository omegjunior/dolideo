...
/**
 *  \file       core/modules/bureauarchives/doc/pdf_standard.modules.php
...
/**
 *	Class to manage PDF template standard_catholicite
 */
class pdf_standard_catholicite extends ModelePDFCatholicite
{
	/**
	...
	public function write_file($object, $outputlangs, $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0)
	{
		...
		*/
		...
		if ($conf->bureauarchives->dir_output.'/catholicite') {
			$object->fetch_thirdparty();

			// Definition of $dir and $file
			if ($object->specimen) {
				$dir = $conf->bureauarchives->dir_output.'/catholicite';
				$file = $dir."/SPECIMEN.pdf";
			} else {
				$objectref = dol_sanitizeFileName($object->ref);
				$dir = $conf->bureauarchives->dir_output.'/catholicite/'.$objectref;
	...
	protected function _pagehead(&$pdf, $object, $showaddress, $outputlangs, $outputlangsbis = null)
	{
		...
		if ($object->statut == $object::STATUS_DRAFT && getDolGlobalString('BUREAUARCHIVES_DRAFT_WATERMARK')) {
			pdf_watermark($pdf, $outputlangs, $this->page_hauteur, $this->page_largeur, 'mm', dol_escape_htmltag(getDolGlobalString('BUREAUARCHIVES_DRAFT_WATERMARK')));
		}
