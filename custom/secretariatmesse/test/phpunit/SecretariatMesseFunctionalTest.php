...
/**
 * \file    test/phpunit/SecretariatMesseFunctionalTest.php
...
/**
 * Class SecretariatMesseFunctionalTest
 *
 ...
 *
 * @package Testsecretariatmesse
 */
class SecretariatMesseFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modSecretariatMesse')->click();
		} else {
			// Disable the module
			$this->byHref('modSecretariatMesse')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/secretariatmesse/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('secretariatmesse/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/secretariatmesse/admin/about.php');
		$this->authenticate();
		return $this->assertContains('secretariatmesse/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('secretariatmessewidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modSecretariatMesse_SecretariatMesseTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modSecretariatMesse_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
