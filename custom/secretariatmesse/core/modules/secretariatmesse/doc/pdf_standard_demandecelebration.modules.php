...
/**
 *  \file       core/modules/secretariatmesse/doc/pdf_standard.modules.php
...
/**
 *	Class to manage PDF template standard_demandecelebration
 */
class pdf_standard_demandecelebration extends ModelePDFDemandeCelebration
{
	/**
	 ...
	 *
	 *  @param		DemandeCelebration	$object				Object to generate
	 ...
	 *
	 *  @param	TCPDF		$pdf     		Object PDF
	 *  @param  DemandeCelebration	$object     	Object to show
	...
	protected function _pagehead(&$pdf, $object, $showaddress, $outputlangs, $outputlangsbis = null)
	{
		...
		// Show Draft Watermark
		if (getDolGlobalString('SECRETARIATMESSE_DRAFT_WATERMARK') && $object->statut == $object::STATUS_DRAFT) {
			pdf_watermark($pdf, $outputlangs, $this->page_hauteur, $this->page_largeur, 'mm', dol_escape_htmltag(getDolGlobalString('SECRETARIATMESSE_DRAFT_WATERMARK')));
		}
