...
/**
 *  \file       core/modules/catechese/doc/pdf_standard.modules.php
 *  \ingroup    catechese
...
/**
 *	Class to manage PDF template standard_registre
 */
class pdf_standard_registre extends ModelePDFRegistre
{
	/**
	...
	public function write_file($object, $outputlangs, $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0)
	{
		...
		*/
		...
		if ($conf->catechese->dir_output.'/registre') {
			$object->fetch_thirdparty();

			// Definition of $dir and $file
			if ($object->specimen) {
				$dir = $conf->catechese->dir_output.'/registre';
				$file = $dir."/SPECIMEN.pdf";
			} else {
				$objectref = dol_sanitizeFileName($object->ref);
				$dir = $conf->catechese->dir_output.'/registre/'.$objectref;
	...
	protected function _pagehead(&$pdf, $object, $showaddress, $outputlangs, $outputlangsbis = null)
	{
		...
		if ($object->statut == $object::STATUS_DRAFT && getDolGlobalString('CATECHESE_DRAFT_WATERMARK')) {
			pdf_watermark($pdf, $outputlangs, $this->page_hauteur, $this->page_largeur, 'mm', dol_escape_htmltag(getDolGlobalString('CATECHESE_DRAFT_WATERMARK')));
		}
