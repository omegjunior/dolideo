...
/**
 *  \file       core/modules/dolideo/doc/pdf_standard.modules.php
 *  \ingroup    dolideo
...
class pdf_standard_demandecelebration extends ModelePDFDemandeCelebration
{
	...
	public function write_file($object, $outputlangs, $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0)
	{
		...
		*/
		...
		if ($conf->dolideo->dir_output.'/demandecelebration') {
			$object->fetch_thirdparty();

			// Definition of $dir and $file
			if ($object->specimen) {
				$dir = $conf->dolideo->dir_output.'/demandecelebration';
				$file = $dir."/SPECIMEN.pdf";
			} else {
				$objectref = dol_sanitizeFileName($object->ref);
				$dir = $conf->dolideo->dir_output.'/demandecelebration/'.$objectref;
	...
	protected function _pagehead(&$pdf, $object, $showaddress, $outputlangs, $outputlangsbis = null)
	{
		...
		if ($object->statut == $object::STATUS_DRAFT && getDolGlobalString('DOLIDEO_DRAFT_WATERMARK')) {
			pdf_watermark($pdf, $outputlangs, $this->page_hauteur, $this->page_largeur, 'mm', dol_escape_htmltag(getDolGlobalString('DOLIDEO_DRAFT_WATERMARK')));
		}
