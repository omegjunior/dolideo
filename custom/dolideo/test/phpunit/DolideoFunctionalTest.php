...
/**
 * \file    test/phpunit/DolideoFunctionalTest.php
 * \ingroup dolideo
 ...
 * @package Testdolideo
 */
class DolideoFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	{
		$this->url('/custom/dolideo/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('dolideo/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/dolideo/admin/about.php');
		$this->authenticate();
		return $this->assertContains('dolideo/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('dolideowidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modDolideo_DolideoTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modDolideo_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
